      ...
      <div className="max-w-6xl mx-auto px-4">
        ...
        <div className="space-y-4 md:space-y-6 mb-8 md:mb-12">
          {experiences.map((exp, index) => (
            <div key={`${exp.title}_${exp.company}_${exp.period}`} className="border border-cyan-800 bg-gray-800/50 p-4 md:p-6 hover:border-cyan-400 transition-all duration-300">
              <div className="grid md:grid-cols-4 gap-4 md:gap-6">
                ...
                <div className="flex flex-col items-center justify-center mt-3 md:mt-0">
                  <div className="w-12 h-12 md:w-14 md:h-14 border-2 border-cyan-400 rounded-full flex items-center justify-center mb-2">
                    {index === 0 ? <Briefcase className="w-6 h-6 md:w-7 md:h-7 text-cyan-400" /> :
                     index === 1 ? <Code className="w-6 h-6 md:w-7 md:h-7 text-cyan-400" /> :
